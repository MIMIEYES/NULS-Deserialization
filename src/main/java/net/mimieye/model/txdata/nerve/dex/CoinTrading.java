 ...
 * 币对交易协议
 */
public class CoinTrading extends BaseNulsData {
    //交易对创建人
    ...
    public String toString() {
        ...
        sb.append(",\"baseAssetChainId\":")
                .append(baseAssetChainId);
        sb.append(",\"baseAssetId\":")
                .append(baseAssetId);
        sb.append(",\"scaleBaseDecimal\":")
                .append(scaleBaseDecimal);
        sb.append(",\"quoteAssetChainId\":")
                .append(quoteAssetChainId);
        sb.append(",\"quoteAssetId\":")
                .append(quoteAssetId);
